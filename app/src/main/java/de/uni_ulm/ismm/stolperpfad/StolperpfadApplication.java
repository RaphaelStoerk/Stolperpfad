...
public class StolperpfadApplication extends Application {
    ...
    public void onCreate() {
        ...
        prefs.edit().putBoolean("de.uni_ulm.ismm.stolperpfad.mode_changed", false).apply();
        mode_changed = prefs.getBoolean("de.uni_ulm.ismm.stolperpfad.mode_changed", false);
    }
    ...
    public void setDarkMode(boolean dark_mode) {
        mode_changed = this.dark_mode != dark_mode;
        prefs.edit().putBoolean("de.uni_ulm.ismm.stolperpfad.mode_changed", mode_changed).apply();
    ...
    public boolean modeHasBeenChanged() {
        return mode_changed;
    }
